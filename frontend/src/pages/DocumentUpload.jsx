...
export default function DocumentUpload() {
  ...
  const handleUploadSuccess = () => {
    ...
    setIngestionStatus({
      status: "processing",
      message:
        "Document uploaded! AI knowledge base is now syncronizing... (This may take a minute)",
    });
    startPolling();
  };
  ...
  const confirmDelete = async () => {
    ...
    try {
      ...
      setDocuments((prev) =>
        prev.filter((doc) => doc !== deleteModal.filename),
      );
  ...
  return (
    <div className="flex-1 overflow-y-auto p-8 bg-slate-50 relative">
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-fade-in">
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 border border-slate-100">
            ...
            <p className="text-slate-500 text-center mb-8">
              ...
              ? This will permanently remove the document and all related
              embeddings from the AI knowledge base.
            </p>
      ...
      <div className="max-w-4xl mx-auto space-y-10">
        ...
        {statusMessage && (
          <div
            className={`fixed bottom-8 left-1/2 -translate-x-1/2 z-[90] rounded-2xl px-6 py-4 flex items-center gap-3 shadow-2xl animate-fade-in border ${
        ...
        {ingestionStatus && (
          <div
            className={`rounded-xl px-5 py-4 flex items-center gap-3 text-sm font-medium shadow-sm transition-all duration-300 ${
          ...
          >
            {ingestionStatus.status === "processing" ? (
              <svg
                className="w-5 h-5 animate-spin text-blue-600 flex-shrink-0"
                fill="none"
                viewBox="0 0 24 24"
              >
                <circle
        ...
        <section>
          <div className="mb-6">
            ...
            <p className="text-slate-500">
              Add new PDF documents to the RAG pipeline. They will be
              automatically processed and available for chat.
            </p>
          </div>
          ...
          {isLoading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {documents.map((doc, idx) => (
                <div
                  key={idx}
                  className="flex items-center gap-3 p-4 bg-white border border-slate-200 rounded-2xl shadow-sm hover:shadow-md transition-all group"
                >
            ...
            <div className="text-center py-20 bg-white border border-slate-200 border-dashed rounded-2xl">
              ...
              <p className="text-slate-400 text-sm mt-1">
                Upload company PDFs above to get started.
              </p>
            </div>
          )}
        </section>
